...
if (grupos.size() > 0) {
%>
<center><h2><font face="Comic Sans MS,arial,verdana">Informacion sobre: <%=grupos.get(0).getNombresUsuario()+" "+ grupos.get(0).getApellidosUsuario()%></font></h2></center>
